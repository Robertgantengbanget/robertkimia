...
<body>
    ...
    <main>
        ...
        <section id="pengantar" class="section">
            ...
            <img src="assets\Ad21XABuJmuHQuYHWozBnVFaIvvXaKYveh6tH8Pg.jpg" alt="Ilustrasi Molekul" style="width: 100%; margin-top: 1rem; border-radius: 8px;">
        </section>
        ...
        <section id="konsep" class="section">
            ...
            <div class="grid">
                <!-- Card Atom -->
                <div class="card">
                    <img src="assets\Class-11-Structure-of-an-Atom.jpg" alt="Struktur Atom">
                    <h3>Struktur Atom</h3>
        ...
        <section id="eksperimen" class="section">
            ...
            <img src="assets\OIP.jpg" alt="Ilustrasi Eksperimen Kimia" style="width: 100%; margin-top: 1rem; border-radius: 8px;">
        </section>
